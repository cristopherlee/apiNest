...
const nestLikeConsoleFormat = (appName = 'NestWinston', options) => winston_1.format.printf((_a) => {
    ...
    const formattedMeta = (options === null || options === void 0 ? void 0 : options.prettyPrint)
        ? (0, util_1.inspect)(JSON.parse(stringifiedMeta), { colors: true, depth: null })
        : stringifiedMeta;
